...
Apple generally provides us as developers plenty of notice to make updates, whether explicit or implied. There are a number of these that I have been done slowly this year for various reasons—High Sierra, Swift 4, iPhone X layout. Starting at WWDC, we could have been updating our apps to be prepared for the iPhone X layout changes, although none of us knew exactly what to expect. All we knew was that “safe area insets” were a thing and we should be using them.
...
_Note:_ I make heavy use of storyboards, so most of my explanations will involve changes in Interface Builder.
