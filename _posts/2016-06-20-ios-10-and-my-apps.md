...
After consuming much of WWDC last week, I wanted to take a few minutes and consider how my apps could be affected by the new announcements. It is too easy to allow a conference like WWDC become more like entertainment than education. Since I mostly just sat in my office at home and watched live session videos as my consumption mechanism, some effort is required to make sure that the videos can translate into real action and improvement. I thought I would take each of my active, or at least semi-active, projects in turn and consider the state of the app, and how I might incorporate some new technologies. Most of this will be “thinking out loud” so that I can try and process some of what I learned.
